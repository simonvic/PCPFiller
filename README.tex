...
\lstdefinelanguage{json}{
	...
	backgroundcolor=\color{hi_background},
	literate=
	*{0}{{{\color{hi_keyword}0}}}{1}
	{1}{{{\color{hi_keyword}1}}}{1}
	{2}{{{\color{hi_keyword}2}}}{1}
	{3}{{{\color{hi_keyword}3}}}{1}
	{4}{{{\color{hi_keyword}4}}}{1}
	{5}{{{\color{hi_keyword}5}}}{1}
	{6}{{{\color{hi_keyword}6}}}{1}
	{7}{{{\color{hi_keyword}7}}}{1}
	{8}{{{\color{hi_keyword}8}}}{1}
	{9}{{{\color{hi_keyword}9}}}{1}
	{\{}{{{\color{hi_keyword}{\{}}}}{1}
	{\}}{{{\color{hi_keyword}{\}}}}}{1}
	{[}{{{\color{hi_keyword}{[}}}}{1}
	{]}{{{\color{hi_keyword}{]}}}}{1},
